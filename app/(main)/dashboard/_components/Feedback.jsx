...
function Feedback() {
  ...
  return (
    <div>
      ...
      <div className='mt-5'>
  {discussionRoomList.map((item, index)=> (item.coachingOption=='Mock Interview'||item.coachingOption=='Ques Ans Prep'||item.coachingOption=='Debate Practice'||item.coachingOption=='Confidence Coaching')&&
          (
